...
CHROMA_PATH = environment_path(
    "RAG_CHROMA_PATH",
    PROJECT_ROOT / "data" / "chroma_db",
)
EVALUATION_FILE = environment_path(
    "RAG_EVALUATION_FILE",
    PROJECT_ROOT / "evaluation" / "evaluation_cases.json",
)

COLLECTION_NAME = environment_string("RAG_COLLECTION_NAME", "rag_docs")

# Use this for the requested 3B version:
LLM_MODEL = environment_string("RAG_LLM_MODEL", "qwen2.5:3b")

# Change to qwen2.5:1.5b for faster CPU testing:
# LLM_MODEL = "qwen2.5:1.5b"

EMBEDDING_MODEL = environment_string(
    "RAG_EMBEDDING_MODEL",
    "nomic-embed-text",
)
